...
// Source: https://receitasdecodigo.com.br/java/classe-java-completa-para-gerar-e-validar-cpf-e-cnpj
public class CPFeCNPJValidator implements ConstraintValidator<CPFeCNPJ, Object>{
	...
	public static void main(String[] args) {
		CPFeCNPJValidator gerador = new CPFeCNPJValidator();
	...
	public boolean isValid(Object value, ConstraintValidatorContext context) {
		...
		return isCNPJ((String)value) || isCPF((String)value);
	}
}